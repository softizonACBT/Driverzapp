...
public class OnlinePayment extends AppCompatActivity {
    ...
    private static final String LOGIN_URL = "http://softizon.tk/Final/insertPayment.php";
    private static final String crimef = "crime";
    private static final String feef = "fee";
    private static final String paidon = "paidon";
...
//paypal services
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nb = (ImageView) findViewById(R.id.imageView6);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (res.equals("Yes")) {
                            ...
                            View b = findViewById(R.id.imageButton11);
...
//update database values completed dilshan
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, paidURL,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Toast.makeText(OnlinePayment.this, "Sucessfully paid", Toast.LENGTH_LONG).show();
                        String sms = "Your traffic ticket worth of " + fz + " for " + ccn.toString() + " was paid sucessfully. Reference Number " + idz.toString();
                        sendsms(telz, sms);
                        String type = "Paid through mobile app";
                        String payD = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
                        addpay(lnl, ccn, fz, idz, type, payD);
                        refresh();
    ...
    public void onPPay(View v) {
        ...
        Intent intent = new Intent(OnlinePayment.this, PaymentActivity.class);
        intent.putExtra(PayPalService.EXTRA_PAYPAL_CONFIGURATION, config);
    ...
    private void addpay(final String licNos, final String crime, final String fee, final String idz, final String type, final String payD) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, LOGIN_URL,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(lno, licNos);
                params.put(crimef, crime);
                params.put(feef, fee);
                params.put(paidon, payD);
                params.put(refno, idz);
                params.put(ptype, type);
